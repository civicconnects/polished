...
const RedesignHero = () => {
    return (
        <section className="h-screen flex flex-col justify-start items-center text-center border-b border-grid-line relative overflow-hidden">
            <div className="absolute inset-x-0 bottom-0 top-[15%] z-0 bg-[#0f0f0f]">
            ...
            <motion.h1
                ...
                className="absolute top-[10%] left-0 right-0 text-[15vw] leading-none tracking-widest text-white font-serif z-10"
            >
                POLISHED
            </motion.h1>
