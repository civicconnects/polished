    ...
    return (
        <section className="relative h-[70vh] min-h-[500px] flex flex-col justify-start items-center text-center px-8 pt-24 overflow-hidden text-[#0f0f0f]" style={{ backgroundColor: '#FFC0CB' }}>
            ...
            <img
                ...
                className="absolute bottom-0 left-1/2 -translate-x-1/2 max-h-[80%] w-auto z-0 opacity-100 pointer-events-none"
            />

            <h1
                className="relative z-10 font-serif text-[4.5rem] md:text-[7.5rem] font-bold leading-none tracking-[0.2em]"
                style={{
